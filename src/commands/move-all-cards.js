var __ = function (program, output, logger, config, trello, translator) {
  ...
  .callback(function (opts) {
    ...
    try {
      sourceListId = translator.getListIdByBoardNameAndListName(opts.sourceBoard, opts.sourceList);
      destinationBoardId = translator.getBoardIdByName(opts.destinationBoard);
      destinationListId = translator.getListIdByBoardNameAndListName(opts.destinationBoard, opts.destinationList);
    } catch (err) {
